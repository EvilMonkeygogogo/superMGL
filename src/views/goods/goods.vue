      ...
      <el-card class="box-card">
        ...
        <div class="text item">
          ...
          >
            ...
            <!-- 是否存销 -->
            <el-table-column prop="discount" label="是否存销"></el-table-column>
            <!-- 日期 -->
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      // 发送给后端
      this.axios
        .post("http://127.0.0.1:664/goods/search", qs.stringify(params))
        .then(response => {
    ...
    getGoodsListByPage() {
      ...
      // 发送ajax请求 把分页数据发送给后端
      this.axios
        .get(`http://127.0.0.1:664/goods/goodslistbypage`, {
